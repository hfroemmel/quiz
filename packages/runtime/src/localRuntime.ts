 ...
 */
import type { Command, PlayerQuizViewModel, QuizRuntime, QuizSnapshot, QuizRuntimeRejection } from '@quiz/contracts'
...
export class LocalQuizRuntime implements QuizRuntime<PlayerQuizViewModel> {
  ...
  constructor(options: LocalQuizRuntimeOptions) {
    ...
    this.content = new ContentService(options.packageDir, [], options.mediaFallbackDirs ?? [])
