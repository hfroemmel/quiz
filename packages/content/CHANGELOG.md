...
- 943ae45: `content build` names the quiz types it wrote.
...
- 3030b8e: A question slot may name its questions, a question may carry two rubrics, and a
  quiz a second mark.
  ...
  them.
- 25132a4: A sheet may say which reader its background text is for.
